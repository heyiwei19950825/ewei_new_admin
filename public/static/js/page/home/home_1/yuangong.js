$(function(){
	var move = -20;
	var zoom = 1.1;
	$(".news_list_yuangong li.li.htm"/*tpa=http://www.redkylin.com/Public/Web/js/.news_list_yuangong li.li*/).each(function(){
		var that=this
		$(that).bind({
			mouseenter:function(){
            ...
            $(".news_list_yuangong li.li2.htm"/*tpa=http://www.redkylin.com/Public/Web/js/.news_list_yuangong li.li2*/).each(function(){
		var that=this
		$(that).bind({
			mouseenter:function(){
				item4Timer=setTimeout(function(){
